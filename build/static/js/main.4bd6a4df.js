    ...
    function c(e) {
      return function(t) {
        d.a
          ...
          .then(function(e) {
            (window.location.href = '/create-react-app-verfinal/build/auth/dashboard'), t({
              type: p.b,
          ...
          d.a
            ...
            .then(function(s) {
              i({
                ...
                streetAddress: r,
                miscAddress: o,
              }), (window.location.href = '/create-react-app-verfinal/build/courses/' + a), console.log(window.location.href), console.log(s.data.students, 'Student response');
            });
        };
      },
          ...
          d.a
            ...
            .then(function(t) {
              v.get('instructor'), n({
                ...
                periods: [],
              }), (window.location.href = '/create-react-app-verfinal/build/auth/dashboard');
            });
        };
      };
  },
      ...
      m = (function(e) {
        ...
        return a(t, e), d(t, [
          ...
          },
          {
            ...
            value: function() {
              this.props.dispatch(
                c.c(this.props.match.params.cuid)
              ), console.log("Let's see what happens here"), console.log(
                this.props.firstName,
                'first name'
              );
            },
...
//# sourceMappingURL=main.4bd6a4df.js.map
