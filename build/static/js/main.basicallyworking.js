!(function(e) {
  ...
  }), (t.p = '/create-react-app-verfinal/build/'), t((t.s = 314));
})([
  function(e, t, n) {
    'use strict';
    ...
    function c(e) {
      return function(t) {
        d.a
          ...
          .then(function(e) {
            (window.location.href = '/create-react-app-verfinal/build/auth/dashboard'), t({ type: p.b, payload: e.data.courses });
          });
      };
    }
    function l(e, t) {
      return function(n) {
        d.a
          ...
          .then(function(e) {
            console.log(
              e.data.courses
            ), (window.location.href = '/create-react-app-verfinal/build/courses/' + e.data.courses._id);
          });
      };
    }
          ...
          d.a
            ...
            .then(function(s) {
              a({
                ...
                streetAddress: r,
                miscAddress: o,
              }), (window.location.href = '/create-react-app-verfinal/build/courses/' + i), console.log(window.location.href), console.log(s.data.students, 'Student response');
            });
        };
      },
          ...
          d.a
            ...
            .then(function(e) {
              console.log(
                e.data.students,
                'Checking after put'
              ), (window.location.href = '/create-react-app-verfinal/build/courses/' + e.data.students.courses);
            });
        };
      },
      w = function(e, t) {
          ...
          n({ type: p.h, username: e, password: t }), d.a
            ...
            .then(function(e) {
              v.set('token', e.data.token, {
                path: '/create-react-app-verfinal/build/',
                maxAge: 86400,
              }), v.set('instructor', e.data.instructor, { path: '/create-react-app-verfinal/build/', maxAge: 86400 }), console.log(v.get('instructor')), n({ type: p.i, fullName: e.data.instructor.fullName });
            })
            .catch(function(e) {
              n({
                type: p.j,
        ...
        return function(n) {
          d.a
            ...
            .then(function(t) {
              v.get(
                'instructor'
              ), n({ type: p.f, coursename: e, _creator: v.get('instructor')._id, periods: [] }), (window.location.href = '/create-react-app-verfinal/build/auth/dashboard');
            });
        };
      };
  },
            ...
            value: function() {
              return !0 === this.props.authenticated
                ? s.a.createElement(p.c, {
                    to: '/create-react-app-verfinal/build/auth/dashboard',
                  })
        ...
        return a(t, e), p(t, [
          {
            ...
            value: function(e) {
              ...
              }), (window.location.href = '/create-react-app-verfinal/build/editStudent/' +
                this.props.id);
            },
          },
          {
            ...
            value: function(e) {
              e.preventDefault(), this.setState({
                ...
                e.target.id,
                'Check target id'
              ), (window.location.href = '/create-react-app-verfinal/build/courses/' +
                this.props.courses);
            },
          },
          {
      ...
      O = o.a.createElement(
        ...
        o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/auth/dashboard',
              component: l.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/addCourse',
              component: b.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/courses/:cuid',
              component: w.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/addStudent/:cuid',
              component: _.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/editStudent/:cuid',
              component: E.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/editCourse/:cuid',
              component: C.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/create-react-app-verfinal/build/info',
              component: x.a,
            })
          )
        )
          ...
          },
          {
            ...
            value: function() {
              return this.state.isSubmitted
                ? s.a.createElement(l.c, {
                    to: '/create-react-app-verfinal/build/courses/' +
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        l.b,
                        {
                          to: '/create-react-app-verfinal/build/addStudent/' +
                            this.props.match.params.cuid,
                        },
                        'Add a new student'
                      )
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        l.b,
                        {
                          to: '/create-react-app-verfinal/build/editCourse/' +
                            this.props.match.params.cuid,
                        },
                        'Edit Course Name'
                      )
                ...
                s.a.createElement(
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        f.b,
                        { to: '/create-react-app-verfinal/build/addCourse' },
                        'Add a new course '
                      )
                    ),
                    s.a.createElement(
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                s.b,
                { to: '/create-react-app-verfinal/build/' },
                ' Sign Up'
              )
            )
          )
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  s.b,
                  { to: '/create-react-app-verfinal/build/info' },
                  'Click here'
                ),
                ' '
              )
  ...
  function(e, t, n) {
    ...
    (function(t) {
      ...
      'undefined' !== typeof t &&
        n.i({
          NODE_ENV: 'production',
          PUBLIC_URL: '/create-react-app-verfinal/build',
        });
      var u = {
